...
* Definições Bolafrine e Sandoval $\times$ Notas de aula/Casella e Berger.   
* Exercícios da aula 18, quem fez?
* E os teoremas, alguma tentativa de provar?
* **Exercício 1:** Seja $X_1, \ldots, X_n$ uma amostra aleatória de $X \sim Normal(\mu, \sigma^2)$, verifique se a distribuição de $\boldsymbol{X} = (X_1, \ldots, X_n)$ pertence a família exponencial multiparamétrica.
