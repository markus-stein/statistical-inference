...
\begin{exer} \rm
Prove que consistência forte de estimadores implica em consistência fraca. %(Proposição 2.2 (i) das 'Notas de Aula', pg. 74)
\end{exer}
...
\noindent Dica: Use $W^\ast(\mat{X})=\log(W(\mat{X}))$ e a Lei Fraca dos Grandes Números. %Rohatgi pagina 348
\end{exer}
