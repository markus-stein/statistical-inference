...
* **Exemplo 3**: Paradoxo do corvo: "todo corvo é preto" equivale a "todo objeto não preto é não corvo"?   
    + Confirmação, equivalência, ... . Definição de probabilidade?

Definição (**Teste de Hipóteses - decisão**): A função $d:\mathcal{X} \rightarrow \{ a_0, a_1 \}$, em que $a_0$ significa à ação de considerar $H_0$ como verdadeira e $a_1$ corresponde à ação de considerar $H_1$ como verdadeira.  
...
Definição (**Região de Aceitação e Região de Rejeição**): A função $d$ divide o espaço amostral $\mathcal{X} = \boldsymbol{A_0} \cup \boldsymbol{A_1}$ e $\boldsymbol{A_0} \cap \boldsymbol{A_1} = \emptyset$ tais que   
  ...
  * $A_0 = \{ (x_1, \ldots, x_n) \in \mathcal{X}; d(x_1, \ldots, x_n) = a_0 \}$, ou $R^c$,   
  
  * $A_1 = \{ (x_1, \ldots, x_n) \in \mathcal{X}; d(x_1, \ldots, x_n) = a_1 \}$, ou $R$.
...
***
### Tarefa: Fazer exercício 13 da lista 2.
