...
* **Exemplo 1**: Seja $\boldsymbol{X} = (X_1, \ldots, X_n)$ uma a.a. de $X \sim Bernoulli(\pi_1)$ e $\boldsymbol{Y} = (Y_1, \ldots, Y_m)$ uma a.a. de $Y \sim Bernoulli(\pi_2)$, tal que $\boldsymbol{X}$ e $\boldsymbol{Y}$ são independentes. Encontre o TRV para testar $H_0: \theta_1 = \theta_2$ contra $H_0: \theta_1 \neq \theta_2$.  
