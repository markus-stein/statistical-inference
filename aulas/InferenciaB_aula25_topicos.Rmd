...
* **Exemplo 2**: *(Teste $t$ pareado)* Seja $(X_1, Y_1), \ldots (X_n, Y_n)$ uma a.a. de $(X, Y) \sim Normal2(\mu_X, \mu_Y, \sigma^2_X, \sigma^2_Y, \rho)$ e $\boldsymbol{Y} = (Y_1, \ldots, Y_m)$ uma a.a. de $Y \sim Normal(\mu_Y, \sigma^2_Y)$. Use o TRV para testar $H_0: \mu_X = \mu_Y$. Dica: mostre que $W_i = X_i - Y_i \sim Normal(\mu_W, \sigma^2_W)$. 
...
* **Exemplo 3**: (*Equilibrio de Hardy-Weinberg*) Seja $\boldsymbol{X} = (X_1, \ldots, X_n)$ uma a.a. de $X \sim Multinomial(N, \pi_1, \pi_2, \pi_3)$. Use o TRV para testar $H_0: \pi_1 = \pi_2 = \pi_3$.  


\vspace{0.5cm}  

* **Exemplo 4**: Tabelas $r \times c$... 
